...
// SDFeedParser
#define COCOAPODS_POD_AVAILABLE_SDFeedParser
#define COCOAPODS_VERSION_MAJOR_SDFeedParser 1
#define COCOAPODS_VERSION_MINOR_SDFeedParser 0
#define COCOAPODS_VERSION_PATCH_SDFeedParser 0
